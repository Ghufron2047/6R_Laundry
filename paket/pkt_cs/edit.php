...
// var_dump($data_cs); // Komentar atau hapus setelah debugging selesai
    ...
    if (edit_cs($_POST) > 0) {
        ...
        echo '<div class="alert">
                <div class="box">
                    ...
                    <button onclick="window.location=\'http://localhost/6R_laundry/paket/pkt_cs/pkt_cs.php\'" class="btn-alert">Ok</button>
                </div>
              </div>';
    } else {  
        // Statement 2
